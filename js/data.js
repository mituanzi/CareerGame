...
const GameData = {
    // ================= 新增：通用性格/价值观题库 =================
    // 设计思路：不涉及具体工作，测的是底层人格特质
    universal: [
        { text: "面对一个复杂且模糊的问题时，你通常的反应是？", choices: { do: { text: "试图拆解逻辑，寻找规律和结构。", effects: {e:0,m:5,y:0}, track: "tech" }, reject: { text: "寻求他人意见，听听专家或朋友怎么说。", effects: {e:0,m:0,y:0}, track: "influence" } } },
        { text: "如果一份工作能给你极高的社会地位，但需要牺牲大量的个人生活，你会？", choices: { do: { text: "接受，成王败寇，没有付出哪有回报。", effects: {e:-10,m:0,y:10}, track: "challenge" }, reject: { text: "拒绝，工作是为了生活，不能本末倒置。", effects: {e:10,m:5,y:-5}, track: "freedom" } } },
        { text: "在一个团队中，你更倾向于扮演哪种角色？", choices: { do: { text: "那个提出新想法、指明方向的人。", effects: {e:0,m:5,y:0}, track: "influence" }, reject: { text: "那个负责落地执行、确保不出错的人。", effects: {e:0,m:0,y:5}, track: "security" } } },
        { text: "面对突如其来的变动（如计划取消、环境改变），你的心态通常是？", choices: { do: { text: "兴奋，变动意味着新的机会，打破僵局。", effects: {e:5,m:5,y:0}, track: "freedom" }, reject: { text: "担忧，变动带来不确定性，还是稳定一点好。", effects: {e:-5,m:0,y:0}, track: "security" } } },
        { text: "你更愿意为什么样的成就而感到自豪？", choices: { do: { text: "帮助了具体的人，解决了他们的痛苦。", effects: {e:0,m:10,y:0}, track: "service" }, reject: { text: "攻克了难题，创造了某种纪录或作品。", effects: {e:0,m:10,y:0}, track: "tech" } } },
        { text: "在做决定时，你更依赖什么？", choices: { do: { text: "数据和事实，哪怕结论很冷酷。", effects: {e:0,m:0,y:0}, track: "tech" }, reject: { text: "直觉和人情，要考虑大家的感受。", effects: {e:0,m:5,y:0}, track: "service" } } },
        { text: "对于“规则”，你的看法是？", choices: { do: { text: "规则就是用来遵守的，没有规矩不成方圆。", effects: {e:0,m:0,y:5}, track: "security" }, reject: { text: "规则是用来打破的，限制只会阻碍创新。", effects: {e:0,m:5,y:0}, track: "freedom" } } },
        { text: "当看到别人犯错时，你通常会选择？", choices: { do: { text: "直接指出，这对大家都好。", effects: {e:0,m:0,y:0}, track: "tech" }, reject: { text: "委婉提醒，或者帮着掩盖，给对方留面子。", effects: {e:0,m:0,y:0}, track: "influence" } } },
        { text: "你理想中的周末是？", choices: { do: { text: "彻底躺平，谁也别找我，我需要充电。", effects: {e:10,m:0,y:0}, track: "security" }, reject: { text: "去尝试没做过的事，比如探险、社交或新爱好。", effects: {e:-5,m:5,y:0}, track: "challenge" } } },
        { text: "如果有一笔资金，你会倾向于？", choices: { do: { text: "存起来或买稳健理财，落袋为安。", effects: {e:0,m:0,y:10}, track: "security" }, reject: { text: "投资自己或创业，博取更大的未来。", effects: {e:0,m:0,y:-10}, track: "challenge" } } }
    ],
